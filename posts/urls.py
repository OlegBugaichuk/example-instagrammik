...
from .views import (IndexView, FeedView, PostDetail, 
                    PostCreate, PostDelete, CommentDelete, PostUpdate, post_like)
...
urlpatterns = [
    ...
    path('posts/success/', TemplateView.as_view(
                                template_name='posts/delete_success.html'), 
